...
public class activityThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* String str="https://firebasestorage.googleapis.com/v0/b/kabirds-a76b6.appspot.com/o/peacock_video.mp4?alt=media&token=f4d95802-44fd-4630-bc24-4649f8dc2e93";
        ...
        databaseReference.child("junglefowl").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void goNext(){
        Intent intent = new Intent(this, map_three.class);
        startActivity(intent);
    }

    public void goNextBird(){
